...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(email, password) {
    var response, _err$response, _err$response2, msg, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          msg = ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || (// if your backend uses top-level message
          (_err$response2 = _t.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.error) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) ||
          // if your backend nests message
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(name, email, password, confirmPassword) {
    var response, _err$response3, _err$response4, msg, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          msg = ((_err$response3 = _t2.response) === null || _err$response3 === void 0 || (_err$response3 = _err$response3.data) === null || _err$response3 === void 0 ? void 0 : _err$response3.message) || ((_err$response4 = _t2.response) === null || _err$response4 === void 0 || (_err$response4 = _err$response4.data) === null || _err$response4 === void 0 || (_err$response4 = _err$response4.error) === null || _err$response4 === void 0 ? void 0 : _err$response4.message) || 'Something went wrong';
          (0, _alerts.showAlert)('error', msg);
        case 3:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
// same function for account details and password
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
    var saveBtn, passwordCurrent, password, confirmPassword;
    return _regenerator().w(function (_context) {
...
var reviewsLeftArrow = document.querySelector('.reviews__arrow--left');
var reviewsRightArrow = document.querySelector('.reviews__arrow--right');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35793" + '/');
